...
module nsrsh_ferrule_clamp() {
    ...
    module blank() {
        ...
        translate([0, limit_switch.y/2, limit_switch.z-prong.z + 1]) block(face_plate, center=ABOVE+LEFT); 
